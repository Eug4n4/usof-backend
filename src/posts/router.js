...
import { createComment, createLike, createOne, getAll, getOne, updatePostAdmin, updatePost, deletePost, deleteLike, addToFavorite, deleteFromFavorites, getComments, getFromFavorites } from "./post.controller.js";
...
postsRouter.get('/:post_id/favorite', authMiddleware, getFromFavorites)
postsRouter.get('/:post_id/comments', ...queryValidator, validationErrors, getComments)
